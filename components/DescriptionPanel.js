...
const Panel = styled.div`
    ...
    height: 100%;
    top: 0;
    ${({active}) => active ? `left: 0; visibility: visible;` : `left: -${theme.imageInfoPanel.width}; visibility: hidden;`}
...
export default function DescriptionPanel({title, description, active, onClose}) {
    return (
            <Panel active={active}>
            <Title>{title}</Title>
